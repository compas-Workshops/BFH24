...
template = Arch(rise=3, span=10, thickness=0.15, depth=0.5, n=30)
...
viewer.scene.add(model, show_blockfaces=False, show_interfaces=True, show_contactforces=True, scale_tension=100)
viewer.show()
